...
HD_PWD='C:/eFPGA/OPDRACHT_2/EX_1_ROT_ENC/EX_1_ROT_ENC.runs/design_1_IP_ROT_ENC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_IP_ROT_ENC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_IP_ROT_ENC_0_0.tcl

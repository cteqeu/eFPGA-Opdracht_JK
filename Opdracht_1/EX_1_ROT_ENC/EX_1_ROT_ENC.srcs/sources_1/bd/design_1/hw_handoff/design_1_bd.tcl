...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ROT_VAL_0 [ create_bd_port -dir O -from 1 -to 0 ROT_VAL_0 ]
  set RT1_0 [ create_bd_port -dir I RT1_0 ]
  set RT2_0 [ create_bd_port -dir I RT2_0 ]

  # Create instance: IP_ROT_ENC_0, and set properties
  set IP_ROT_ENC_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:IP_ROT_ENC:1.0 IP_ROT_ENC_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_ports LEDs] [get_bd_intf_pins processing_system7_0/GPIO_0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins IP_ROT_ENC_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net IP_ROT_ENC_0_ROT_VAL [get_bd_ports ROT_VAL_0] [get_bd_pins IP_ROT_ENC_0/ROT_VAL]
  connect_bd_net -net RT1_0_1 [get_bd_ports RT1_0] [get_bd_pins IP_ROT_ENC_0/RT1]
  connect_bd_net -net RT2_0_1 [get_bd_ports RT2_0] [get_bd_pins IP_ROT_ENC_0/RT2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins IP_ROT_ENC_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins IP_ROT_ENC_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IP_ROT_ENC_0/S00_AXI/S00_AXI_reg] -force

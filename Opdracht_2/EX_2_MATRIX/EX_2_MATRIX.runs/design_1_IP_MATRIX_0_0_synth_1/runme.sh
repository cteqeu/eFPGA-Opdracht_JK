...
HD_PWD='C:/eFPGA/OPDRACHT_2/2/EX_2_MATRIX/EX_2_MATRIX.runs/design_1_IP_MATRIX_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_IP_MATRIX_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_IP_MATRIX_0_0.tcl

...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DS [ create_bd_port -dir O DS ]
  set SH [ create_bd_port -dir O SH ]
  set ST [ create_bd_port -dir O ST ]

  # Create instance: IP_MATRIX_0, and set properties
  set IP_MATRIX_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:IP_MATRIX:1.0 IP_MATRIX_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins IP_MATRIX_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net IP_MATRIX_0_ds [get_bd_ports DS] [get_bd_pins IP_MATRIX_0/ds]
  connect_bd_net -net IP_MATRIX_0_sh_cp [get_bd_ports SH] [get_bd_pins IP_MATRIX_0/sh_cp]
  connect_bd_net -net IP_MATRIX_0_st_cp [get_bd_ports ST] [get_bd_pins IP_MATRIX_0/st_cp]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins IP_MATRIX_0/clk_10MHz] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins IP_MATRIX_0/reset] [get_bd_pins clk_wiz_0/locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins IP_MATRIX_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins IP_MATRIX_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net vhdlnoclk_0_clk65MHz [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins vhdlnoclk_0/clk65MHz]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IP_MATRIX_0/S00_AXI/S00_AXI_reg] -force
